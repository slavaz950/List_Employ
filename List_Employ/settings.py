"""
Django settings for List_Employ project.
...
DATABASES = {
    'default': {
        ...
        'NAME': 'ListEmployDB', # Имя Базы Данных
...
STATIC_URL = 'static/'
STATICFILES_DIR = os.path.join(BASE_DIR, 'main/static/')  # Каталог для статичных файлов

...
переменных из модели, а не (к примеру) имена полей таблиц из базы данных.
 
При необходимости использования полей других моделей (таблиц), внутри сериализатора 
формируются вложенные сериализаторы.    
